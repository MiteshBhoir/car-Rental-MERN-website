  ...
  return (
    <div>
      <motion.div
        ...
        className='flex flex-col py-20 items-center bg-light max-md:px-4'>
        <Title title="Available Cars" subTitle="Browse our selection of premium vehicles availabel for your next adventure" />
        <motion.div
