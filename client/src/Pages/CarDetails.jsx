...
const CarDetails = () => {
  const { currency, navigate, cars, pickupDate, setPickupDate, returnDate, setReturnDate, axios } = useAppContext();
  const { id } = useParams();
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <motion.div
          ...
          <motion.img
            ...
            src={car.image} className='w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadow-md' alt="" />
          <motion.div className='space-y-6'
            ...
            <div>
              ...
              <ul className='grid gris-cols-1 sm:grid-cols-2 gap-2'>
                {[
                  "360 Camera", "Bluetooth", "Heated Seats", "GPS", "Apple CarPlay"
                ].map((item) => (
